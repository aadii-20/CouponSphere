// How CouponSphere Works

const data_1 = [
  {
    summary: "What is CouponSphere?",
    text: `Founded in 2010, CouponSphere is India's largest discounts, offers, and cashback website. At CouponSphere, we help you save money through our comprehensive listing of coupons, offers, deals, and discounts from 2000+ online brands including top stores like Flipkart, Amazon, MakeMyTrip, PayTM, and BookMyShow. 
  
  You can also earn real money in the form of Cashback on top of the merchant discounts every time you shop through us. Once you have 250 or more CouponSphere cashback, you can transfer it when and as you like - into your bank account, for a mobile recharge, or Flipkart/Amazon vouchers. All you have to do to earn is:
  
  1. Visit CouponSphere and find a store/deal you like.
  ...
  **Recommended watch:** What is CouponSphere Cashback?
  ...
  **Where does Cashback money come from?**  
  CouponSphere is an affiliate marketing company. This means that when you shop via us on our partner stores, we get paid a "commission" by the store. We give 70-100% of this commission to you as cashback. 
  ...
  In case you want to contact us, visit our Contact Us page or drop us a mail at contact@CouponSphere.in`
  },
  {
    summary: "What are the benefits of using CouponSphere?",
    text: `Before you shop online, you should visit CouponSphere to get these benefits:
  
  1. **Real Money as Cashback**  
     - CouponSphere offers CouponSphere Cashback on most popular stores.  
     - This cashback is OVER & ABOVE store discounts.  
     - Cashback can be withdrawn without any fee/deduction.  
  
     **Note:** CouponSphere provides the highest and best Cashback rates on most popular websites.
  ...
  3. **CouponSphere Special Coupon Codes**  
     - We have exclusive coupons for Oyo, MCouponSphereonald's, HealthKart, HappyEasyGo & more.  
  ...
  5. **Product Deals**  
     - Shop for electronics and fashion directly from CouponSphere.  
     - View cashback details to know exactly how much you’ll save.
  
  6. **Be the First to Know About Offers**  
     - Get exclusive deals straight to your inbox by subscribing to our newsletter.`
  },
  {
    summary: "What is CouponSphere cashback?",
    text: `CouponSphere Cashback is real money that you can earn over & above the discounts you get when shopping online. Stores and offers that have additional cashback can be identified by looking for labels in green, like '+ Upto 5% CouponSphere Cashback' or '+ Flat Rs. 100 CouponSphere Rewards' etc. 
        The cashback you earn from CouponSphere can be in the form of :
        1. CouponSphere Cashback - When you shop on any store except Flipkart & Amazon. All withdrawal options are available.

        2. CouponSphere Rewards - Only when you shop on FLIPKART. All withdrawal options are available EXCEPT Bank Account withdrawal.

        3. CouponSphere Voucher Rewards - Only when you shop on AMAZON. Can ONLY be withdrawn as Amazon Pay Voucher.
  ...
  {
    summary: "What are CouponSphere Rewards?",
    text: `CouponSphere Rewards is cashback earned when you shop on FLIPKART via CouponSphere.

               This cashback is given the different name "CouponSphere Rewards" because Flipkart does not allow withdrawal of this cashback to a bank account.

               The process for earning of CouponSphere Rewards is the same as CouponSphere Cashback. CouponSphere Rewards can be withdrawn and used for mobile or DTH Recharge and converted to Flipkart Gift Card or Amazon Pay Voucher. 
               In short, you can withdraw CouponSphere Rewards as you like, except to a bank account. This is why the balance available for bank transfer may be less than your total available balance.`
  },
  {
    summary: "What are CouponSphere Voucher Rewards?",
    text: `CouponSphere Voucher Rewards is cashback earned when you shop on AMAZON via CouponSphere.

               This cashback is given the different name "CouponSphere Voucher Rewards" because Amazon allows withdrawal of this cashback ONLY to Amazon Pay Voucher.The process for earning of CouponSphere Voucher Rewards is the same as CouponSphere Cashback. `
  },
  {
    summary: "How do I find a store on CouponSphere?",
  ...
  },
  {
    ...
    text: `Earning cashback via CouponSphere is as easy as 1-2-3.

               1. LOGIN & BROWSE: Login to CouponSphere  & search for the store or category you are looking for.
  ...
  {
    summary: "What are tips and tricks of using CouponSphere?",
    text: `To ensure successful cashback tracking, we recommend the following:

               1. Login to CouponSphere and click on one of the RED BUTTONS to start shopping on that store. Do NOT visit the merchant directly. 
               ...
               5. Finish shopping in the same browser window and in the same session. If you need to come back later to shop, visit CouponSphere and click on the Red button again.`
  },
  {
    summary: "Report a missing store or offer",
    text: `Please do write to us on support@CouponSphere.in or contact us and let us know which store or offer you could not find on CouponSphere. We will try our best to add it to our site!`
  },
  {
    summary: "How do I list my business on CouponSphere?",
    text: `Please send us an email at contact@CouponSphere.in or submit your details through an automated form.`
  },
...
1. Go to the merchant page on CouponSphere (for example: Flipkart )
...
},
{
  ...
  text: `To ensure your cashback gets tracked when you shop via CouponSphere, we suggest you completely disable ad blocking software during your shopping sessions.
...
4. Come back to CouponSphere, click on the offer you like, and click on "I've disabled ABP on target store" to continue shopping as usual.
...
3. Reload CouponSphere page and continue shopping as usual.
...
4. Come back to CouponSphere, click on the offer you like, and click on "I've disabled uBlock on target store" to continue shopping as usual.
...
Make sure you are logged into your CouponSphere account.
...
When you click an offer or store, CouponSphere will open a window linking you to that store. Please ensure that you transact in the opened window.
Please ensure that you start with an empty shopping cart. If it is not empty please clear the contents of your cart and visit the store via CouponSphere again.
...
},
{
  ...
  text: `The pending cashback tracked amounts are calculated by CouponSphere on a best effort basis and can change upon final confirmation from the store. 
...
{
  summary: "How many days will it take to actually get my CouponSphere cashback?",
...
{
  summary: "Where can I check CouponSphere cashback I've earned?",
  text: `You can check your CouponSphere cashback in your CouponSphere profile as follows:

1. Login to CouponSphere 
...
},
{
  ...
  text: `Pending Balance contains amounts that you have earned but can't yet withdraw. Your pending balance contains amounts from purchases made at cashback stores and/or any bonus amount that you might have earned from CouponSphere.
...
2. You completed the purchase in the same session after clicking out of CouponSphere

3. You did not use any other widget or comparison site after getting redirected from CouponSphere.
...
Mobile Users: Use the CouponSphere Android App for improved tracking.
...
It can take upto 48 hours for CouponSphere Cashback to get tracked. In case your transaction was not tracked even after 48 hours, please file a Missing Cashback Claim for the transaction which was Not Tracked. Please note, merchants accept claims for cashback not tracked cases only till 7th of the subsequent month from the purchase date.`
  },
  {
...
1. Outclick - Date and time when you clicked out from CouponSphere
...
The order did not comply with the store's cashback policy. To see details on store specific cashback policy please see the 'Useful Tips' section on CouponSphere Store pages.
...
const data_5 = [
  {
    ...
    text: `Cashback earned from CouponSphere is your money and can be used to recharge online wallet, phone or DTH accounts or even transferred to your bank account. (Note: Minimum withdrawal limit of 250 applies)
...
Read withdrawal options and limits for details.`
  },
  {
    ...
    text: `CouponSphere gives you multiple options to withdraw your available balance as shown below:
...
All these details are mentioned when you go to the Profile->Withdraw Money page. `
  },
  {
    ...
    text: `To withdraw your balance, log in to your CouponSphere account and visit the withdraw money section of your profile.
...
Bank transfers take between 5-7 business days to reflect in your account. eWallet and Recharge transactions are almost instantaneous but can take upto 48 hours to reflect in your account. Note: Cashback earned from some merchants (CouponSphere Rewards) cannot be withdrawn to a bank account and is listed separately as rewards. Minimum withdrawal limits apply.

Also, there is absolutely no cost or fees applicable to withdrawing your balance.`
  },
  {
    summary: "Can I transfer my balance to another CouponSphere account?",
    text: `Sorry, we do not allow transfer of balance from one CouponSphere account to another.`
  },
  {
    summary: "I'm getting an error while withdrawing my balance. What do I do?",
    text: `We're sorry that you are facing a problem with your withdrawal. Please reach out to our Customer Care team at support@CouponSphere.in for assistance in resolving this issue.`
  },
  {
...
You can reach out to our Customer Care team at support@CouponSphere.in for assistance in resolving withdrawal related issues.`
  },
];
